        ...
        <div id='body' style={{ cursor: "default" }}>
          ...
          <div className="content">
            ...
            >
              ...
              <GridItem>
                <Text fontSize={width > 1200 ? "xl" : "xl"} lineHeight="taller">
          ...
          <div className="content">
            <Card.Root width={"fit-content"} height={width > 1200 ? "fit-content" : "90vh"} marginBottom={20}>
              <Text p={5} pb={1} width={"100%"} textAlign={"center"} fontSize={"4xl"} fontWeight="bold" lineHeight="taller">
                HOW DOES IT WORK?
              </Text>
